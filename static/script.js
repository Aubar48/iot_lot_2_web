...
document.getElementById('dataForm').addEventListener('submit', function (event) {
    ...
    fetch('/data', { // Llama al endpoint '/data' en tu app de Flask
        ...
        body: JSON.stringify({ sensor, value, message }), // Convierte los datos a formato JSON
    })
...
document.getElementById('updateForm').addEventListener('submit', function (event) {
    ...
    const sensor = document.getElementById('updateSensor').sensor;
    const value = document.getElementById('updateValue').value;
    const message = document.getElementById('updateMessage').message;
    ...
    fetch(`/data/${id}`, { // Llama al endpoint '/data/{id}' en Flask para actualizar
        ...
        body: JSON.stringify({ sensor, value, message }),
    })
        .then(response => response.json())
        .then(data => {
            document.getElementById('response').innerText = data.message || data.error;
    ...
    fetch('/data') // Llama al endpoint '/data' para obtener los datos
        ...
        `;
            ...
            data.data.forEach(item => {
                ...
                const idCellGraph = document.createElement('td');
                idCellGraph.innerText = item.id;
                rowPlain.appendChild(idCellGraph);
                ...
                const messageCellPlain = document.createElement('td');
                messageCellPlain.innerText = item.message;
                rowPlain.appendChild(messageCellPlain);
